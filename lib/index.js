...
module.exports = SpriteBrunch = (function() {
  ...
  SpriteBrunch.prototype.onCompile = function(changedFiles) {
    ...
    alldone = [];
    if (spriteFolders) {
      return spriteFolders.forEach(function(folder) {
  ...
  SpriteBrunch.prototype.generateSprites = function(files, foldername, format) {
    ...
    spritesmith(spritesmithParams, function(err, result) {
      ...
      return done.resolve({
        coordinates: _this.processCoordinates(result.coordinates, foldername, imageFile, result.properties),
        imageFile: imageFile,
  ...
  SpriteBrunch.prototype.processCoordinates = function(coordinates, foldername, imageFile, properties) {
    var new_coordinates;
    new_coordinates = [];
